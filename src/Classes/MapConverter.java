...
public class MapConverter {
    ...
    private static final double minLon = -3.035000;
    private static final double maxLon = -2.988478;
    private static final double difLon = maxLon - minLon;

    private static final double minLat = 53.396700;
    private static final double maxLat = 53.457561;
    private static final double difLat = maxLat - minLat;

    private static final int minCol = 0;
    private static final int maxCol = 53;
    private static final int minRow = 0;
    private static final int maxRow = 35;
